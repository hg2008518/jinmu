...
public class PullToRefreshLayout extends RelativeLayout
{
	...
	{
		// 初始化下拉布局
		pullView = refreshView.findViewById(R.id.pulltorefresh_pull_icon);
		refreshStateTextView = (TextView) refreshView
				.findViewById(R.id.pulltorefresh_state_tv);
		refreshingView = refreshView.findViewById(R.id.pulltorefresh_refreshing_icon);
		refreshStateImageView = refreshView.findViewById(R.id.pulltorefresh_state_iv);
		// 初始化上拉布局
		pullUpView = loadmoreView.findViewById(R.id.pulltorefresh_pullup_icon);
		loadStateTextView = (TextView) loadmoreView
				.findViewById(R.id.pulltorefresh_loadstate_tv);
		loadingView = loadmoreView.findViewById(R.id.pulltorefresh_loading_icon);
		loadStateImageView = loadmoreView.findViewById(R.id.pulltorefresh_loadstate_iv);
	}
